...
public class Notificaitons {
    ...
    public final static String ACTION_SIMPLE = "com.evloution.picturebanner.notification.ACTION_SIMPLE";
    public final static String ACTION_ACTION = "com.evloution.picturebanner.notification.ACTION_ACTION";
    public final static String ACTION_REMOTE_INPUT = "com.evloution.picturebanner.notification.ACTION_REMOTE_INPUT";
    public final static String ACTION_BIG_PICTURE_STYLE = "com.evloution.picturebanner.notification.ACTION_BIG_PICTURE_STYLE";
    public final static String ACTION_BIG_TEXT_STYLE = "com.evloution.picturebanner.notification.ACTION_BIG_TEXT_STYLE";
    public final static String ACTION_INBOX_STYLE = "com.evloution.picturebanner.notification.ACTION_INBOX_STYLE";
    public final static String ACTION_MEDIA_STYLE = "com.evloution.picturebanner.notification.ACTION_MEDIA_STYLE";
    public final static String ACTION_MESSAGING_STYLE = "com.evloution.picturebanner.notification.ACTION_MESSAGING_STYLE";
    public final static String ACTION_PROGRESS = "com.evloution.picturebanner.notification.ACTION_PROGRESS";
    public final static String ACTION_CUSTOM_HEADS_UP_VIEW = "com.evloution.picturebanner.notification.ACTION_CUSTOM_HEADS_UP_VIEW";
    public final static String ACTION_CUSTOM_VIEW = "com.evloution.picturebanner.notification.ACTION_CUSTOM_VIEW";
    public final static String ACTION_CUSTOM_VIEW_OPTIONS_LOVE = "com.evloution.picturebanner.notification.ACTION_CUSTOM_VIEW_OPTIONS_LOVE";
    public final static String ACTION_CUSTOM_VIEW_OPTIONS_PRE = "com.evloution.picturebanner.notification.ACTION_CUSTOM_VIEW_OPTIONS_PRE";
    public final static String ACTION_CUSTOM_VIEW_OPTIONS_PLAY_OR_PAUSE = "com.evloution.picturebanner.notification.ACTION_CUSTOM_VIEW_OPTIONS_PLAY_OR_PAUSE";
    public final static String ACTION_CUSTOM_VIEW_OPTIONS_NEXT = "com.evloution.picturebanner.notification.ACTION_CUSTOM_VIEW_OPTIONS_NEXT";
    public final static String ACTION_CUSTOM_VIEW_OPTIONS_LYRICS = "com.evloution.picturebanner.notification.ACTION_CUSTOM_VIEW_OPTIONS_LYRICS";
    public final static String ACTION_CUSTOM_VIEW_OPTIONS_CANCEL = "com.evloution.picturebanner.notification.ACTION_CUSTOM_VIEW_OPTIONS_CANCEL";

    public final static String ACTION_YES = "com.evloution.picturebanner.notification.ACTION_YES";
    public final static String ACTION_NO = "com.evloution.picturebanner.notification.ACTION_NO";
    public final static String ACTION_DELETE = "com.evloution.picturebanner.notification.ACTION_DELETE";
    public final static String ACTION_REPLY = "com.evloution.picturebanner.notification.ACTION_REPLY";
    ...
    public void sendSimpleNotification(Context context, NotificationManager nm) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            nb = new Notification.Builder(context, NotificationChannels.LOW)
                    //设置通知左侧的小图标
    ...
    public void sendMediaStyleNotification(Context context, NotificationManager nm, boolean isPlaying) {
        ...
        Notification.Builder nb = null;
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            nb = new Notification.Builder(context, NotificationChannels.MEDIA)
                    //设置通知左侧的小图标
                    .setSmallIcon(R.mipmap.ic_notification)
                    //设置通知标题
    ...
    public void sendMessagingStyleNotification(Context context, NotificationManager nm) {
        ...
        Notification.Builder nb = null;
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            nb = new Notification.Builder(context, NotificationChannels.DEFAULT)
                    //设置通知左侧的小图标
                    .setSmallIcon(R.mipmap.ic_notification)
                    //设置通知标题
