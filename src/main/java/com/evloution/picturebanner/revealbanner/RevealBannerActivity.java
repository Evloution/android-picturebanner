package com.evloution.picturebanner.revealbanner;
...
/**
 * @Description：轮播图片，状态栏也跟着改变
 * @Author： Evloution_
 * @Date： 2019-12-16
 * @Email： 15227318030@163.com
 */

public class RevealBannerActivity extends AppCompatActivity implements OnBannerItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_revealbanner);
    ...
    public void onBannerClick(int index, ArrayList<BannerInfo> banner) {
        Log.e("iiii", "点击的是：" + index);
        Log.e("ssss", "banner：" + banner.get(index).title);
    }
